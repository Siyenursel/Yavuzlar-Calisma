...
<body>
    ...
    <div class="container vh-100 d-flex justify-content-center align-items-center">
        <div class="border border-2 border-primary px-5 py-5 " style="backdrop-filter: blur(8px);">
            <form class="login" action="./Fonk/Kullanıcı/derslerEkle.php" method="POST">
            ...
            <form action="./Fonk/Ders/derslerEkle.php" method="POST">
                <h2 class="position-relative ">Ders Ekle</h2>

                
                <div class="form-group">
                    <label style="color: #F97171;">Ders İsmi</label>
